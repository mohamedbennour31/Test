 ...
 */
final class Version20241014145703 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vol (id INT AUTO_INCREMENT NOT NULL, aeroport_id INT DEFAULT NULL, ville_destination VARCHAR(255) NOT NULL, date_de_depart DATE NOT NULL, date_darrivee DATE NOT NULL, INDEX IDX_95C97EBF1089B86 (aeroport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
